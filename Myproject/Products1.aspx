<%@ Page Title="动漫交流" Language="C#" MasterPageFile="~/user.master" AutoEventWireup="true" CodeFile="Products1.aspx.cs" Inherits="Products" %>
        ...
        <asp:Repeater ID="rptrProducts" runat="server">
            <ItemTemplate>
                <div class="col-sm-3 col-md-3">
                    ...
                    <div class="thumbnail">
                        <img src="images/ProductImages/02/<%#DataBinder.Eval(Container.DataItem,"image") %>" alt="image"/>
                        <div class="caption">
