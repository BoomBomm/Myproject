...
public class DataBase:IDisposable
{
    ...
    private void Open()
    {
        ...
        if (con == null)
        {
            con = new SqlConnection(ConfigurationManager.ConnectionStrings["cartoon111ConnectionString1"].ToString());
        }
    ...
    /// <summary>
    /// 执行命令文本，返回DataTable数据库
    /// </summary>
    /// <param name="procName">命令文本</param>
    /// <returns></returns>
    public DataTable RunProcReturnTable(string procName)
    {
        SqlDataAdapter dap = CreateDataAdaper(procName, null);
